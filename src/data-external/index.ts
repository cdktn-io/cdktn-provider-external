...
// https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs/data-sources/external
...
export class DataExternal extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataExternal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs/data-sources/external#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs/data-sources/external external} Data Source
  *
  * @param scope The scope in which to define this construct
