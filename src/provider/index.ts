...
// https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs
...
export class ExternalProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing ExternalProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/external/2.4.1/docs external} Resource
  *
  * @param scope The scope in which to define this construct
