...
# CDKTN prebuilt bindings for hashicorp/external provider version 2.4.0

This repo builds and publishes the [Terraform external provider](https://registry.terraform.io/providers/hashicorp/external/2.4.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform external provider](https://registry.terraform.io/providers/hashicorp/external/2.4.0)
